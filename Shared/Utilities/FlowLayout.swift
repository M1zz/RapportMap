...
//
//  A custom layout that arranges its children in a flowing manner,
//  wrapping to the next line when needed (similar to how text wraps).
//  Shared between iOS and macOS targets.
//
    ...
    struct FlowResult {
        ...
        init(in maxPossibleWidth: CGFloat, subviews: Subviews, spacing: CGFloat) {
            ...
            for subview in subviews {
                ...
                if currentX + size.width > maxPossibleWidth && currentX > 0 {
                    // Move to next line
                    currentX = 0
